...
namespace OBSNotifier.Modules.Event.Default
{
    public partial class DefaultNotificationWindow : Window
    {
        ...
        public DefaultNotificationWindow(DefaultNotification module) : base()
        {
            ...
            owner = module;
            hide_delay = new DeferredActionWPF(() => Hide(), 200, true);
        ...
        void UpdateParameters()
        {
            ...
            var maxSize = Screens.ScreenFromWindow(this).Bounds;
            var newSize = new PixelSize(
              (int)Utils.Clamp(owner.SettingsTyped.BlockSize.Width, 1, maxSize.Width),
              (int)Utils.Clamp(owner.SettingsTyped.BlockSize.Height * owner.SettingsTyped.Blocks, 1, maxSize.Height));
            ...
            PixelPoint pos = Utils.GetModuleWindowPosition(this, owner.SettingsTyped.DisplayID, anchor, newSize, owner.SettingsTyped.Offset, owner.SettingsTyped.UseSafeDisplayArea);
        ...
        void ShowWithLocationFix()
        {
            ...
            if (!IsPositionedOnTop)
            {
                ...
                //  if (delta > 0)
                //      Position = new PixelPoint(0, Position.Y + delta);
            }
        }
