...
namespace OBSNotifier
{
    partial class Settings
    {
        ...
        [JsonIgnore]
        readonly DeferredActionWPF saveSettings = new(() => Instance.SaveInternal(), 1000, true);
        [JsonIgnore]
        ...
        public PixelRect SettingsWindowRect { get; set; } = new(-1, -1, 0, 0);
        ...
        static readonly JsonSerializerOptions jsonOptions = new()
        {
            ...
            Converters = {
                ...
                new PixelRectJsonConverter(),

                new PointJsonConverter(),
                new PixelPointJsonConverter(),

                new SizeJsonConverter(),
                new PixelSizeJsonConverter(),
